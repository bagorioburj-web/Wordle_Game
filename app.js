...
const EMAILJS_CONFIG = {
  enabled: true, 
  publicKey: "s1sanswEydiUHVsN1", 
  serviceId: "service_h49vzj1", 
  templateId: "template_qq8tkgz",
};
...
function buildInviteTextEmail() {
  return (
    "Burj and Grace's Invitation Card\n" +
    ...
    "Things to Bring\n" +
    "(Pack before 7:00 PM)\n\n" +
    "Bring no money, my treat, kahit dalhin mo lng sarili mo baby sapat ka na saken\n\n" +
...
<html>
  <head>
    ...
    <title>Burj and Grace's Invitation Card</title>
  </head>
          ...
          <table role="presentation" width="600" cellspacing="0" cellpadding="0" border="0" style="max-width:600px;width:100%;background:${card};border-radius:18px;overflow:hidden;box-shadow:0 14px 40px rgba(122,31,51,0.14);border:1px solid rgba(122,31,51,0.10);">
            <tr>
              <td style="padding:20px 18px;background:linear-gradient(135deg, ${blush}, #ffffff);">
                <div style="font-family:Arial, Helvetica, sans-serif;color:${maroon};text-align:center;font-weight:700;font-size:22px;line-height:1.25;">Burj and Grace's Invitation Card</div>
            ...
            <tr>
              <td style="padding:18px 18px 8px 18px;">
                ...
                <div style="font-family:Arial, Helvetica, sans-serif;color:${text};font-size:14px;line-height:1.55;">
                  <div><b>DATE:</b> February 14, 2026 (Saturday)</div>
                  <div><b>Call Time:</b> 7:00 PM</div>
                  <div><b>Theme:</b> White </div>
                </div>
              </td>
            </tr>
            <tr>
              <td style="padding:10px 18px 8px 18px;">
                ...
                <div style="font-family:Arial, Helvetica, sans-serif;color:${muted};font-size:12px;margin:0 0 10px 0;">(Pack before 6:00 PM)</div>
                <ul style="margin:0;padding-left:18px;font-family:Arial, Helvetica, sans-serif;color:${text};font-size:14px;line-height:1.55;">
                  <li>Bring no money, my treat, kahit dalhin mo lng sarili mo baby sapat ka na saken</li>
                </ul>
              </td>
            </tr>
            <tr>
